...
public class BoardDTO {
	...
	public int getRe_revel() {
		return re_revel;
	}
	public void setRe_revel(int re_revel) {
		this.re_revel = re_revel;
	}
	...
	public String toString() {
		return "BoardDTO [num=" + num + ", writer=" + writer + ", subject=" + subject + ", passwd=" + passwd
				...
				+ ", re_revel=" + re_revel + ", content=" + content + ", ip=" + ip + ", comment_count=" + comment_count
